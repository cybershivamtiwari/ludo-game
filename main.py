...
logoab = PhotoImage(file="blue dice.png")
logoay = PhotoImage(file="yellow dice.png")
logoag = PhotoImage(file="green dice.png")
...
def board():  # Drawing the board, piece by piece.
    ...
    # Splash Screen.
    tkinter.messagebox.showinfo(title="information", message="TO START GAME PRESS OKAY! made by shivam tiwari 1901320100154 ")
    v = 0
    z = 0
...
class YBox:  # Class of yellow box
    ...
    def __init__(self, num=-1, x=0, y=0, x0=0, y0=0, double=False, ):
        ...
        self.x0 = x0
        self.y0 = y0
        self.rap = Label(image=logoay, width=30, height=30)  # image of game piece.
...
class GBox:  # Class of green box
    ...
    def __init__(self, num=-1, x=0, y=0, x0=0, y0=0, double=False, ):
        ...
        self.x0 = x0
        self.y0 = y0
        self.rap = Label(image=logoag, width=30, height=30)
        self.double = double
...
class BBox:  # Class of Blue box
    ...
    def __init__(self, num=-1, x=0, y=0, x0=0, y0=0, double=False, ):
        ...
        self.x0 = x0
        self.y0 = y0
        self.rap = Label(image=logoab, width=30, height=30)
        self.double = double
...
class Box:  # class of red box
    ...
    def __init__(self, num=-1, x=0, y=0, x0=0, y0=0, double=False, ):
        ...
        self.x0 = x0
        self.y0 = y0
        self.rap = Label(image=logo3, width=30, height=30)
        self.double = double
...
button = Button(root, text="Click Here To turn", relief="raised", font=("Arial", 15), command=roll)  # call roll function evertime this button is clicked
